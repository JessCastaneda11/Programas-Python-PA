...
print(f'c2 diferencia c3: elem c2 no en c3 { c2 - c3 }')
...
print('\nSubconjuntos ')
print(f'c4 es sub conj de c1 ? : {c4.issubset(c1)}')
print(f'c3 es super conj de c2 ? : {c3 <= c2}')

print('\nPertenencia o no pertenencia a un conjunto')
print(f'Esta 2 en c1 ? {2 in c1}')
print(f'Esta 6 en c1 ? {6 not in c1}')